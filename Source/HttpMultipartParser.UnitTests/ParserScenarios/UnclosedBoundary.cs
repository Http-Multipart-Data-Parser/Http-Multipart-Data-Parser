...
namespace HttpMultipartParser.UnitTests.ParserScenarios
{
	public class UnclosedBoundary
	{
		...
		public async Task DoesntInfiniteLoopOnUnclosedInputAsync()
		{
			...
			{
				// We expect this to throw!
				await Assert.ThrowsAsync<MultipartParseException>(() => MultipartFormDataParser.ParseAsync(stream, Encoding.UTF8, cancellationToken: TestContext.Current.CancellationToken));
			}
		}
	}
}
